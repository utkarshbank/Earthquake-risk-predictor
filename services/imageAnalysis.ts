...
async function getGeminiAnalysis(imageUrl: string): Promise<any> {
    ...
    try {
        ...
        const prompt = `
            Perform a deep seismic analysis of this hazard map.
...
export const analyzeMapImage = async (
    ...
    const geminiDataPromise = getGeminiAnalysis(imageUrl);
